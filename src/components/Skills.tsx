  ...
  return (
    <section id="skills" className="py-24 px-20 bg-[#F8FAFC]">
      <div className="max-w-[1280px] mx-auto">
        <h2 className="text-4xl font-bold text-center mb-4 text-[#020617] font-['Poppins']">Skills & Expertise</h2>
          ...
          {skills.map((skill, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[#020617] mb-2 font-['Poppins']">{skill.title}</h3>
